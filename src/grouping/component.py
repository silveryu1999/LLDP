...
class function:
    def __init__(self, name, prev, next, nextDis, nextBytes, source, runtime, input_files, output_files, conditions):
        self.name = name
        self.prev = prev
        self.next = next
...
class workflow:
    def __init__(self, workflow_name, start_functions, nodes: Dict[str, function], global_input, total, parent_cnt, foreach_functions, merge_functions, dag, topo, out):
