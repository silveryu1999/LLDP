...
random_df = pd.read_csv('Random_avg.csv')
palette_df = pd.read_csv('Palette_avg.csv')

# draw avg latency
ax1 = fig.add_subplot(1, 1, 1)

y_1 = list(faasflow_df['avg_latency'])
y_2 = list(random_df['avg_latency'])
y_3 = list(palette_df['avg_latency'])
...
plt.suptitle("static-single-6rpm-50MB")
