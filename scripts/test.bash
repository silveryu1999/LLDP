...
#NETWORK_INTERFACE_NAMES=$(docker_container_interfaces_in_network "07472796c55d" "bridge")

CONTAINER_INTERFACES=$(docker_container_get_interfaces "07472796c55d")
echo $CONTAINER_INTERFACES
NETWORK_INTERFACES=$(docker_network_get_interfaces "bridge")
echo $NETWORK_INTERFACES
